...
# NOTA (receta local, no la oficial de python-for-android): la única
# diferencia con la receta original es la URL de descarga. El servidor
# oficial (download.savannah.gnu.org) empezó a devolver "502 Bad Gateway"
# de forma consistente (confirmado en dos compilaciones seguidas, con los
# 4 reintentos automáticos agotados en ambas). Se usa SourceForge en su
# lugar -- el otro canal de distribución oficial de FreeType (mencionado
# incluso en el docstring original de esta receta). El resto de la clase
# es una copia exacta de la receta oficial de python-for-android
# (v2024.01.21); no se tocó su lógica de compilación con harfbuzz.
#
# Aviso honesto: no pude verificar esta URL alterna en mi propio entorno
# de pruebas (mi sandbox tiene bloqueado sourceforge.net por su propia
# configuración de red, sin relación con GitHub Actions). Es la alternativa
# mejor fundamentada que pude dar sin poder probarla directamente.
